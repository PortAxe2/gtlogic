<template>
    <p class="incentiveHeader" id="incentiveListId">REASONS TO JOIN GTLOGIC</p>
    <p class="incentiveBrief">
    ...
    <div class="incentiveList">
        <div class="incentive">
            <img class="incentiveImg" src="../assets/growth.svg" alt="">
            <div class="incentiveTxt">
                <p class="incentiveTxtHeader">OPPORTUNITY TO GROW</p>
        ...
        <div class="incentive">
            <img class="incentiveImg" src="../assets/aboutme.svg" alt="">
            <div class="incentiveTxt">
                ...
                <p class="incentiveTxtBrief">
                    ...
                    their requested landing page, as well as doing smaller
                    personal projects to solidify my knowledge.
                </p>
            </div>
        </div>
        <div class="incentive">
            <img class="incentiveImg" src="../assets/flexibility.svg" alt="">
            <div class="incentiveTxt">
                <p class="incentiveTxtHeader">FLEXIBILITY</p>
                <p class="incentiveTxtBrief">
                    Flexible work hours and having the ability to work
                    from home are a superb bonus. Being able to finish tasks, on time of course,
                    but at your own pace is great.
                </p>
            </div>
        </div>
    </div>
...
<style scoped>
@import '../assets/style/incentive.css';
</style>
